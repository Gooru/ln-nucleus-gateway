...
public final class RouteConstants {
  ...
  // List Codes for Domains in Taxonomy = /api/nucleus/{version}/taxonomy/subjects/{subject-id}/courses/{course-id}/domains/{domain-id}/codes
  public static final String EP_STANDARDS_LIST_BY_DOMAINS =
    API_BASE_ROUTE + ENTITY_TAXONOMY + SEP + ENTITY_TX_SUBJECT + SEP + COLON + ID_TX_SUBJECT + SEP + ENTITY_TX_COURSE + SEP + COLON + ID_TX_COURSE +
      SEP + ENTITY_TX_DOMAIN + SEP + COLON + ID_TX_DOMAIN + SEP + ENTITY_TX_CODES;
  // List Standards Frameworks = /api/nucleus/{version}/taxonomy/standard-frameworks
  public static final String EP_STANDARDS_FRAMEWORK_LIST = API_BASE_ROUTE + ENTITY_TAXONOMY + SEP + RES_TX_STANDARD_FRAMEWORK;

  // List Root codes = /api/nucleus/{version}/taxonomy/standard-frameworks/{standard-framework-id}/codes
  ...
  // List Sub codes = /api/nucleus/{version}/taxonomy/standard-frameworks/{standard-framework-id}/codes/{code-id}/codes
  ...
  // List 21st Century Skills = /api/nucleus/{version}/lookups/21-century-skills
  ...
  // Add an Existing Unassigned Question to Assessment = /api/nucleus/{version}/assessments/{assessment-id}/questions
  ...
  // Add an existing Question to Collection = /api/nucleus/{version}/collections/{collection-id}/questions
  ...
  // Move an existing unit to existing course PUT /api/nucleus/{version}/courses/{course-id}/units
  public static final String EP_COURSE_MOVE_UNIT = API_BASE_ROUTE + ENTITY_COURSES + SEP + COLON + ID_COURSE + SEP + ENTITY_UNITS;
  // Reorder courses in subject bucket = PUT /api/nucleus/{version}/courses/reorder
  ...
  // Move an existing lesson to existing Course/Unit = PUT /api/nucleus/v1/courses/:courseId/units/:unitId/lessons
  ...
  // Move existing collection/assessment into existing CUL = /api/nucleus/v1/courses/:courseId/units/:unitId/lessons/:lessonId/collections
  ...
  // Retrieve a specific Class by the Class Code = /api/nucleus/{version}/classes/{classId}
  public static final String EP_CLASS_GET = API_BASE_ROUTE + ENTITY_CLASSES + SEP + COLON + ID_CLASS;
  // List members of a Class (joined or pending) = /api/nucleus/{version}/classes/{class-id}/members
  ...
  // Fetch All Classes - for User (active and archived along with course association information) = /api/nucleus/{version}/classes
  public static final String EP_CLASS_LIST = API_BASE_ROUTE + ENTITY_CLASSES;
  // Fetch All Classes assigned to a specific Course = /api/nucleus/{version}/classes/courses/{course-id}
  public static final String EP_CLASSES_FOR_COURSE = API_BASE_ROUTE + ENTITY_CLASSES + SEP + ENTITY_COURSES + SEP + COLON + ID_COURSE;
  // Remove a student from class who has joined already = /api/nucleus/{version}/classes/{classId}/members/{userId}
  public static final String EP_CLASS_STUDENT_REMOVE = API_BASE_ROUTE + ENTITY_CLASSES + SEP + COLON + ID_CLASS + SEP + OP_MEMBER + SEP + ID_USER;
  ...
  // Remove invitation from a Class = /api/nucleus/{version}/classes/{class-id}/invites/{emailId}
  public static final String EP_CLASS_INVITE_REMOVE = API_BASE_ROUTE + ENTITY_CLASSES + SEP + COLON + ID_CLASS + SEP + OP_INVITE + SEP + ID_EMAIL;
  ...
  // Associate a Course with the Class = /api/nucleus/{version}/classes/{class-id}/courses/{courseId} with an empty payload
  ...
  // Publish content of a Course to a specific Class = /api/nucleus/{version}/classes/{class-id}/courses
  ...
  // Copy unit /api/nucleus/{version}/copier/courses/{course-id}/units/{unit-id}?target_course_id=
  ...
  //Copy lesson /api/nucleus/{version}/copier/courses/{course-id}/units/{unit-id}/lessons/{lesson-id}?target_course_id=&target_unit_id=
