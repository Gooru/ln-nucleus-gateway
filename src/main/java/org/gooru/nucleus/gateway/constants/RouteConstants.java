...
public final class RouteConstants {
    ...
    private static final String ENTITY_TX_LEARNER_CLASSIFICATIONS = "learner-classifications";
    ...
    // List Learner Classifications =
    // /api/nucleus/{version}/taxonomy/learner-classifications
    public static final String EP_LEARNER_CLASSIFICATION_LIST = API_BASE_ROUTE + ENTITY_TAXONOMY + SEP + ENTITY_TX_LEARNER_CLASSIFICATIONS;
