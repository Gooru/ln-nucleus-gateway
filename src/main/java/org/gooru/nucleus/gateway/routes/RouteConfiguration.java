...
public class RouteConfiguration implements Iterable<RouteConfigurator> {
  ...
  public RouteConfiguration() {
    ...
    configurators.add(new RouteRubricConfigurator());
    ...
    configurators.add(new RouteCollectionExternalConfigurator());
    ...
    configurators.add(new RouteLibraryConfigurator());
    configurators.add(new RouteRbacConfigurator());
